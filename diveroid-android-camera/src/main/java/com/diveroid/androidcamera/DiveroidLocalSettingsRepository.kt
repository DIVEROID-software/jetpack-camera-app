...
import com.google.jetpackcamera.settings.JcaSettingsSerializer
...
class DiveroidLocalSettingsRepository(private val context: Application) : SettingsRepository {
    private val FILE_LOCATION = "diveroid_app_settings.pb"
    val jcaSettings = DataStoreFactory.create(
